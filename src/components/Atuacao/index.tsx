...
const Atuacao = () => {
  return (
    <Container id="atuacao" className={scss.container} backgroundColor={'backgroundGray800'}>
      <div className={scss.heroText}>
        ...
        <div>
          <p className={scss.CallContent}>
            ...
            clientes com o objetivo de obter para as pessoas a adoção de procedimentos corretos com
            a utilização de teses jurídicas sólidas e atualizadas.
